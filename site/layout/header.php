...
<html>
    <head>
        ...
        <link rel="stylesheet" href="public/vendor/fontawesome-free-6.2.1-web/css/all.min.css">
        ...
        <nav class="navbar navbar-default desktop-menu">
            <div class="container">
                <ul class="nav navbar-nav navbar-left hidden-sm hidden-xs">
                    ...
                    <li class="<?=$a == "returnPolicy" ? "active" : ""?>"><a href="index.php?c=information&a=returnPolicy">Chính sách đổi trả</a></li>
                    <li class="<?=$a == "paymentPolicy" ? "active" : ""?>"><a href="index.php?c=information&a=paymentPolicy">Chính sách thanh toán</a></li>
                    <li class="<?=$a == "deliveryPolicy" ? "active" : ""?>"><a href="index.php?c=information&a=deliveryPolicy">Chính sách giao hàng</a></li>
