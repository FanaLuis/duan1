        ...
        <div class="row">
            <aside class="col-md-6 cart-checkout">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 text-right">
                        <span class="payment-total" data="<?=$cart->getTotalPrice()?>"><?=number_format($cart->getTotalPrice() + $shipping_fee)?>₫</span>
                    </div>
                </div>
            </aside>
            <div class="ship-checkout col-md-6">
                ...
                <br>
                <?php endif ?>
                <form action="index.php?c=payment&a=order" method="POST" autocomplete="off">
